			...
			$.each(json, function(key, item) {
				...
				if (id == "Q6") {
			        ...
			        if (id == "Q2") {
			            ...
			            var str = "<div class='videoPic'><img src='images/videopic.png' /></div>" + "<iframe height=563 width=1000 src='http://player.youku.com/embed/XMTQ5MTE1NTkzMg==' frameborder=0 'allowfullscreen'></iframe>"
			            $(".Video").html(str)
			            return;
			        }
